        ...
        <div style={{ flex: '1 1 340px', display: 'flex', flexDirection: 'column', gap: 16 }}>
          <Card>
            <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontWeight: 700, fontSize: 'var(--fs-md)', color: 'var(--ink)' }}>
                  Suhay Sevinc
                </div>
        ...
        <div style={{ flex: '1 1 280px', display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              {[
                ...
                <div key={name} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: 'var(--fs-xs)', fontWeight: 600, color: 'var(--ink)' }}>
                      {name}
                    </div>
                    <div
                      style={{
          ...
          <Card title="Abwesenheiten">
            <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
              ...
              <span style={{ fontSize: 'var(--fs-2xs)', color: 'var(--ink-2)' }}>
                Urlaub verbleibend
              </span>
            </div>
          </Card>
