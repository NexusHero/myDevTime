function ProjectsScreen() {
  ...
  const projects = [
    { name: 'Finanzo AG', client: 'Retainer · 78€/h', pct: 62, color: 'var(--project-1)', spark: [6, 7.5, 8, 5, 7, 2, 0], hours: '96,5h', budget: '160h' },
    { name: 'Nordwind GmbH', client: 'Fixed scope', pct: 91, color: 'var(--project-3)', spark: [3, 4, 5, 6, 4, 0, 0], hours: '72,8h', budget: '80h' },
    { name: 'Sync engine', client: 'Intern · kein Budget-Cap', pct: 34, color: 'var(--project-2)', spark: [2, 3, 2, 4, 3, 1, 0], hours: '41,2h', budget: '—' },
    { name: 'Atlas Relaunch', client: 'T&M · 92€/h', pct: 18, color: 'var(--project-4)', spark: [0, 1, 2, 3, 2, 4, 0], hours: '14,5h', budget: '80h' },
  ];
            ...
            <Card>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 'var(--fs-xs)', color: 'var(--ink-2)', marginTop: 2 }}>{p.client}</div>
                </div>
