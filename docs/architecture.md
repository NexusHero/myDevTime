...
| REQ-009 | Timesheet & invoice-ready export (CSV/XLSX/PDF): rates, rounding profile, totals — every number traceable to the deterministic `buildTimesheet`; serializers behind per-format adapters | ADR-0005/0020, [#14](https://github.com/NexusHero/myDevTime/issues/14) | CSV + XLSX done (#14); PDF is #14 Phase C |
