...
| [0044](0044-ui-architecture-simplification.md) | **UI Architecture Simplification Strategy**: Phased adoption of a Universal UI Framework (e.g. Tamagui) instead of hand-rolled components, adoption of Moti for standard UI animations, and Expo Router for standard responsive layouts to reduce accidental complexity and improve Web Accessibility. | Proposed |
## Tech Radar
...
| Universal UI Framework (Tamagui / Gluestack) | Assess (replacing custom UI components) | ADR-0044 |
| Moti (Declarative UI animations) | Assess (abstracting react-native-reanimated) | ADR-0044 |
